...
import { User_examen } from 'src/app/models/user_examen';
...
@Component({
  selector: 'app-module1user',
  templateUrl: './module1user.component.html',
  styles: [
  ]
})
export class Module1userComponent implements OnInit {
  list : Examen[] = []
  content: string;
  ...
  ngOnInit(): void {
    ...
    this.exam_serv.getexamenm1Id().subscribe(data=>{
      let x:any=[]
     // console.log(data)
...
Enable()
{
  this.exam_serv.getexamenm1Id().subscribe(data=>{
   ...
   Active() {
    ...
    this.exam_serv.getUserExamenactif(this.idUser["id"]).subscribe(data=>{
      console.log(data);
  ...
  examM1(){
    this.exam_serv.getexamenm1().subscribe(data => {
  ...
  showFiles1(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads1 = this.coursService.getFilesCours1S1();
      console.log(this.fileUploads1);
    }
  }
  //cours2
  ...
  showFiles2(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads2 = this.coursService.getFilesCours1S2();
    }
  }
  //cours3
  ...
  showFiles3(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads3 = this.coursService.getFilesCours1S3();
    }
  }
    ...
    showFiles4(enable: boolean) {
      ...
      if (enable) {
        this.fileUploads4 = this.coursService.getFilesCours1S4();
      }
    }
        //cours5
        ...
        showFiles5(enable: boolean) {
          ...
          if (enable) {
            this.fileUploads5 = this.coursService.getFilesCours1S5();
          }
        }
