...
@Component({
  selector: 'app-module3user',
  templateUrl: './module3user.component.html',
  styles: [
  ]
})
export class Module3userComponent implements OnInit {
  content: string;
  ...
  ngOnInit(): void {
    ...
    this.exam_serv.getexamenm3Id().subscribe(data=>{
      let x:any=[]
     // console.log(data)
  ...
  Enable()
{
  ...
  Active() {
    ...
    this.exam_serv.getUserExamenactifM3(this.idUser["id"]).subscribe(data=>{
      console.log(data);
  ...
  examM3(){
    this.exam_serv.getexamenm3().subscribe(data => {
  ...
  showFiles1(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads1 = this.coursService.getFilesCours3S1();
    }
  }
  //cours2
  ...
  showFiles2(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads2 = this.coursService.getFilesCours3S2();
    }
  }
  //cours3
  ...
  showFiles3(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads3 = this.coursService.getFilesCours3S3();
    }
  }
    ...
    showFiles4(enable: boolean) {
      ...
      if (enable) {
        this.fileUploads4 = this.coursService.getFilesCours3S4();
      }
    }
        //cours5
        ...
        showFiles5(enable: boolean) {
          ...
          if (enable) {
            this.fileUploads5 = this.coursService.getFilesCours3S5();
          }
        }
