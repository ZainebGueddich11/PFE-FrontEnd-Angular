...
@Component({
  selector: 'app-module4user',
  templateUrl: './module4user.component.html',
  styles: [
  ]
})
export class Module4userComponent implements OnInit {
  content: string;
  ...
  ngOnInit(): void {
    ...
    this.exam_serv.getexamenm4Id().subscribe(data=>{
      let x:any=[]
     // console.log(data)
  ...
  examM4(){
    this.exam_serv.getexamenm4().subscribe(data => {
  ...
  showFiles1(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads1 = this.coursService.getFilesCours4S1();
    }
  }
  //cours2
  ...
  showFiles2(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads2 = this.coursService.getFilesCours4S2();
    }
  }
  //cours3
  ...
  showFiles3(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads3 = this.coursService.getFilesCours4S3();
    }
  }
    ...
    showFiles4(enable: boolean) {
      ...
      if (enable) {
        this.fileUploads4 = this.coursService.getFilesCours4S4();
      }
    }
        //cours5
        ...
        showFiles5(enable: boolean) {
          ...
          if (enable) {
            this.fileUploads5 = this.coursService.getFilesCours4S5();
          }
        }
