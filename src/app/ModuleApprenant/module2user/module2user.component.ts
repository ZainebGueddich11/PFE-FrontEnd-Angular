...
@Component({
  selector: 'app-module2user',
  templateUrl: './module2user.component.html',
  styles: [
  ]
})
export class Module2userComponent implements OnInit {
  content: string;
 ...
 y:any;
  ...
  ngOnInit(): void {
    ...
    this.exam_serv.getexamenm2Id().subscribe(data=>{
      let x:any=[]
     // console.log(data)
  ...
  examM2(){
    this.exam_serv.getexamenm2().subscribe(data => {
   ...
   Active() {
    ...
    this.exam_serv.getUserExamenactifM2(this.idUser["id"]).subscribe(data=>{
      console.log(data);
   ...
   Enable()
{
  ...
  showFiles1(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads1 = this.coursService.getFilesCours2S1();
    }
  }
  //cours2
  ...
  showFiles2(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads2 = this.coursService.getFilesCours2S2();
    }
  }
  //cours3
  ...
  showFiles3(enable: boolean) {
    ...
    if (enable) {
      this.fileUploads3 = this.coursService.getFilesCours2S3();
    }
  }
    ...
    showFiles4(enable: boolean) {
      ...
      if (enable) {
        this.fileUploads4 = this.coursService.getFilesCours2S4();
      }
    }
        //cours5
        ...
        showFiles5(enable: boolean) {
          ...
          if (enable) {
            this.fileUploads5 = this.coursService.getFilesCours2S5();
          }
        }
