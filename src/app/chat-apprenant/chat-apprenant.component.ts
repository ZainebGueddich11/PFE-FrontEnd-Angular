...
@Component({
  selector: 'app-chat-apprenant',
  templateUrl: './chat-apprenant.component.html',
  styleUrls: ['./chat-apprenant.component.css']
})
export class ChatApprenantComponent implements OnInit {
...
error = false ;
  ...
  private auth : AuthService,private tokenStorageService: TokenStorageService,) { }
  ngOnInit(): void {
